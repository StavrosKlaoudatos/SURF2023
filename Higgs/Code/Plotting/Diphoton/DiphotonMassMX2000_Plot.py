...
for i, (name, df) in enumerate(dict.items()):
    ...
    y,b,m = plt.hist(x, bins=200, alpha=0.5, linewidth=2, color=color, label=name,histtype='step', range = (0,2000))
...
plt.title('Diphoton Mass $m_{\gamma\gamma}$ in MX2000', loc='left')
