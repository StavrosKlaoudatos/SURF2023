...
for i, (name, df) in enumerate(Dict.items()):
    ...
    y,b,m = plt.hist(x, bins=200, alpha=0.5, linewidth=2, color=color, label=name,histtype='step', range = (0,1500))
...
plt.text(-170,27500, modes_str, bbox=dict(facecolor='blue', alpha=0.5))




plt.title('Lead Photon Transverse Momentum $p_T$ in MX2000', loc='left')
